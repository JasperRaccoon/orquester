...
/**
 * Toast for connection trouble: a spinner + "Reconnecting… attempt N" while the
 * client retries a dropped/restarted transport, or a "Disconnected" card with
 * Retry when it gives up. Hidden during normal startup and while the auth
 * prompt is showing.
 *
      ...
      {reconnecting ? (
        ...
        <>
          ...
          <button
            ...
            className="rounded-full bg-neutral-200 px-3 py-0.5 text-xs font-medium text-neutral-900 hover:bg-neutral-50"
          >
            Retry
          </button>
        </>
